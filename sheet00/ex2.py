...
ax = data_c.plot(x='delta',y='rel_err_rounded',kind='scatter',marker='.',label='rel_err_rounded')
data_c.plot(x='delta',y='rel_err_better',kind='scatter',marker='.',color='r',label='rel_err_better',ax=ax)
